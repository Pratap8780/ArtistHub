<%@ Page Title="" Language="C#" MasterPageFile="~/user/UserMaster.Master" AutoEventWireup="true" CodeBehind="UserHome.aspx.cs" Inherits="bca6.user.UserHome" %>
       ...
       <div id="carouselExampleIndicators" class="carousel slide mx-5 mt-4" data-bs-ride="carousel">
        ...
        <div class="carousel-inner" style="height: 60vh">
            <div class="carousel-item active">
                <img src="../images/bg1.jpg" class="d-block w-100 rounded-3" alt="..."/>
            </div>
            <div class="carousel-item" data-bs-interval="2000">
                <img src="../images/bg31.jpg" class="d-block w-100 rounded-3" alt="..."/>
            </div>
            <div class="carousel-item">
                <img src="../images/bg mandala 4.jpg" class="d-block w-100 rounded-3" alt="..."/>
            </div>
        </div>
